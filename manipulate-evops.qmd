...
2. Click on the **Kernel** tab from the Jupyter menu.

3. Select **Restart Kernel** in the scrolling menu. This will stop and clear all outputs. The notebook can then rerun in a clean environment.


![listing_045](./listing_045.jpg){width=100%}
...
## Delete saved a pipeline output
...
3. Double-click on the **workspace** directory to display its contents.

4. Browse to find and right-click on the element to delete.

5. Select **Delete** in the scrolling menu and confirm the action.




![listing_046](./listing_046.jpg){width=100%}



![listing_047](./listing_047.jpg){width=100%}
